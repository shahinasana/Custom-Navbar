// 1. Global Loop Breaker for Avatar
(function () {
...
$(document).on('app_ready', function() {
    // Remove the setTimeout to inject navbar immediately
    injectCustomNavbar();
...
// $(document).on('app_ready', function() {
//     setTimeout(injectCustomNavbar, 1500);
//     $('#notif-count-badge').hide();
...
function injectCustomNavbar() {
    ...
    var navbarHTML = `
        <nav class="navbar-custom">
            <div class="nav-left">
                <a href="/app" class="brand-gold">Tally ERP</a>
                <div class="menu-group" data-menu="sales">
                    <span class="menu-caption">Sales ▾</span>
                </div>
                <div class="menu-group" data-menu="purchase">
                    <span class="menu-caption">Purchase ▾</span>
                </div>
            </div>
    ...
    // Create separate menu containers appended to body
    const salesMenuHTML = `
        <div class="floating-menu-content" id="sales-menu-content" style="display:none;">
            <a href="/app/sales-order">Sales Order</a>
            <a href="/app/sales-invoice">Sales Invoice</a>
            <a href="/app/customer">Customers</a>
        </div>
    `;
    
    const purchaseMenuHTML = `
        <div class="floating-menu-content" id="purchase-menu-content" style="display:none;">
            <a href="/app/purchase-order">Purchase Order</a>
            <a href="/app/supplier">Suppliers</a>
        </div>
    `;
    ...
    $('body').append(salesMenuHTML);
    $('body').append(purchaseMenuHTML);
